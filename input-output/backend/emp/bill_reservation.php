...
<table border="0">
  <thead align="right">
    ...
    <tr>
      ...
      <th width="150"><?=number_format($row['book_total'],2)?> บาท</th>
    </tr>
    <tr>
      <th></th>
      <th></th>
      <th>ส่วนลด</th>
      <th><?=number_format($row['book_discount'],2)?> บาท</th>
    </tr>
    <tr>
      <th></th>
      <th></th>
      <th>รวมสุทธิ</th>
      <th><?=number_format($row['book_total']-$row['book_discount'],2)?> บาท</th>
    </tr>
    <tr>
      <th></th>
      <th></th>
      <th><font size="+2">ค่ามัดจำ</font> </th>
      <th><font size="+2"><?=number_format($row['book_deposit'],2)?> บาท</font></th>
    </tr>
    <tr>
      <th></th>
      <th></th>
