...
<?php 
	if(isset($_POST['submit']))
	{
		...
		$db->query("UPDATE booklist SET booklist_checkout = '$nowdate' where book_id = '$book_id'");
		...
		<tbody align="center">
			...
			<tr>
				<td colspan="2">
					...
					<!--<a class="btn btn-secondary" href="confirm_checkout.php?id=<?=$row1['book_id']?>">ล้างค่า</a>-->
