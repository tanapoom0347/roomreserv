...
?>
<form method="post" action="update_qty2.php">
<h1 align="center" style="color:black">เลือก/ยกเลิกห้องพัก</h1>
<div align="center"><a class="btn btn-primary" href="search_room.php">เพิ่มห้องพัก</a>  |  <a class="btn btn-danger" href="cart_room.php?clearcart" onclick="return confirm('ท่านต้องการล้างตะกร้าใช่หรือไม่?');">ล้างตระกร้า</a>  |  <input class="btn btn-success" type="submit" value="ยืนยันการจอง"></div>
<br>
...
<thead align="center">
  <tr>
  	  <th width="80"><div align="center">ลำดับ</div></th>
      <th ><div align="center">รูปห้องพัก</div></th>
      <th width="100"><div align="center">ชื่อห้องพัก</div></th>
      <th width="150"><div align="center">ราคาห้องพัก(บาท)</div></th>
  ...
  {	
	  ...
	  <tr height="140">
		...
		<td align="center"><a href="cart_room.php?Line=<?=$i;?>" onclick="return confirm('ท่านต้องการยกเลิกห้องพักหรือไม่?');">ยกเลิก</a></td>
	  </tr>
	  <?php }}$db->close();?>
</tbody></table></div></ul>
